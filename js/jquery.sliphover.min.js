        ...
        init: function () {
            if (!/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
                ...
                e(this.element).off("mouseenter.sliphover", i).on("mouseenter.sliphover", i, function () {
                    ...
                    o.off("mouseenter.sliphover mouseleave.sliphover").on("mouseenter.sliphover mouseleave.sliphover",
                        function (r) {
            ...
            if (h = i.settings.verticalMiddle ? e("<div>").css({
                display: "table-cell", verticalAlign: "middle", padding: "10px", "line-height": "25px", "letter-spacing": "1px"
            }).html(r.attr(i.settings.caption)) : r.attr(i.settings.caption),
                c = r.parent("a"), c.length && i.settings.withLink) {
                var d = c.attr("href"),
                    f = c.attr("target");
                a = e("<a>", {
            ...
            return l = i.settings.backgroundColorAttr ? r.attr(i.settings.backgroundColorAttr) : i.settings.backgroundColor,
                a.css({
                    width: "100%",
                    ...
                    textAlign: i.settings.textAlign, color: i.settings.fontColor, backgroundColor: l
                }).html(h), a
            ...
            switch (o) {
                case 0:
                    r = { bottom: "100%", left: 0 };
                    break;
                case 1: r = { bottom: 0, left: "100%" };
                    break;
                case 2: r = { bottom: "-100%", left: 0 };
                    break;
                case 3: r = { bottom: 0, left: "-100%" };
                    break;
            ...
            var i = e.width(),
                ...
                s = Math.round((Math.atan2(n, r) * (180 / Math.PI) + 180) / 90 + 3) % 4;
            return s
        }
    }, 
    e.fn[o] = function (t) {
